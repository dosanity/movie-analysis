...
# plt.show()
plt.savefig('Number-Of-Movies-per-Year.png')
...
# plt.show()
plt.savefig('Average-Rating-per-Year.png')
...
# plt.show()
plt.savefig('Number-of-Votes-per-Year.png')
...
# plt.show()
plt.savefig('Average-Number-of-Votes-per-Year.png')